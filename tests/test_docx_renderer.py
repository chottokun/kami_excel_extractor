...
def test_docx_rendering_hybrid_structure(tmp_path):
    ...
    structured_data = {
        "sheets": {
            "現場写真": {
                "summary": "現場写真のリストです。",
                "data": [{"coord": "A3", "filename": "chart.png", "type": "image"}],
                "photos": [
                    {
                        "photo_no": "No.1",
                        "title": "クラック発生状況",
                ...
                "cells": [
                    {
                        ...
                        "row": 1,
                        "col": 1,
                        "value": "写真 No.1: クラック発生状況",
                        "style": {"borders": {}, "bold": True},
                    }
                ],
                "media": [{"coord": "A3", "filename": "chart.png", "visual_summary": "画像データ"}],
            }
        }
    }
