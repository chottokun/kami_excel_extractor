...
def create_business_report_excel(path: Path):
    ...
    data = [["2024-01", 1000, 1100, "110%"], ["2024-02", 1000, 950, "95%"], ["2024-03", 1200, 1300, "108%"]]
    ...
    for i, coord in enumerate(["A3", "C3"]):
        ...
        ws2[coord].border = Border(
            top=Side(style="medium"), left=Side(style="medium"), right=Side(style="medium"), bottom=Side(style="medium")
        )
