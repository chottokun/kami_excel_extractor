...
def test_convert_to_table_extra_keys_ignored():
    ...
    converter = JsonToMarkdownConverter()
    data = [{"ID": 1, "Name": "Alice", "Secret": "hidden"}, {"ID": 2, "Name": "Bob", "Secret": "hidden"}]
    keys = ["ID", "Name"]
    result = converter._convert_to_table(data, keys)
