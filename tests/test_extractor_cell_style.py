...
def test_cell_to_html_td_styles(tmp_path):
    ...
    clean_val = "Test8"
    style_str = extractor._get_cell_style_string(cell_8)
    unit = extractor._get_unit_info(cell_8)

    html_8 = extractor._cell_to_html_td(cell_8, None, clean_val, style_str, unit)
    ...
    clean_val = "Test6"
    style_str = extractor._get_cell_style_string(cell_6)
    unit = extractor._get_unit_info(cell_6)

    html_6 = extractor._cell_to_html_td(cell_6, None, clean_val, style_str, unit)
    ...
    clean_val = "Test0"
    style_str = extractor._get_cell_style_string(cell_0)
    unit = extractor._get_unit_info(cell_0)

    html_0 = extractor._cell_to_html_td(cell_0, None, clean_val, style_str, unit)
    ...
    clean_val = "TestNoFill"
    style_str = extractor._get_cell_style_string(cell_no_fill)
    unit = extractor._get_unit_info(cell_no_fill)

    html_no_fill = extractor._cell_to_html_td(cell_no_fill, None, clean_val, style_str, unit)
    ...
    clean_val = "TestNoColor"
    style_str = extractor._get_cell_style_string(cell_no_color)
    unit = extractor._get_unit_info(cell_no_color)

    html_no_color = extractor._cell_to_html_td(cell_no_color, None, clean_val, style_str, unit)
