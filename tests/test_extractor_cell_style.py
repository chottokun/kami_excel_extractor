...
def test_cell_to_html_td_styles(tmp_path):
    ...
    html_8 = extractor._cell_to_html_td(cell_8, None, "Test8", style_8, None)
    ...
    html_6 = extractor._cell_to_html_td(cell_6, None, "Test6", style_6, None)
    ...
    html_0 = extractor._cell_to_html_td(cell_0, None, "Test0", style_0, None)
    ...
    html_no_fill = extractor._cell_to_html_td(cell_no_fill, None, "TestNoFill", style_no_fill, None)
    ...
    html_no_color = extractor._cell_to_html_td(cell_no_color, None, "TestNoColor", style_no_color, None)
