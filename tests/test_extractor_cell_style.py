...
def test_cell_to_html_td_styles(tmp_path):
    ...
    html_8 = extractor._cell_to_html_td(cell_8, None, style_str_8, None)
    ...
    html_6 = extractor._cell_to_html_td(cell_6, None, style_str_6, None)
    ...
    html_0 = extractor._cell_to_html_td(cell_0, None, style_str_0, None)
    ...
    html_no_fill = extractor._cell_to_html_td(cell_no_fill, None, style_str_nf, None)
    ...
    html_no_color = extractor._cell_to_html_td(cell_no_color, None, style_str_nc, None)
