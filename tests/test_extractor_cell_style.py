...
def test_cell_to_html_td_styles(tmp_path):
    ...
    html_8 = extractor._cell_to_html_td(cell_8, None, clean_val="Test8", style_str=style_8, unit=None)
    ...
    html_6 = extractor._cell_to_html_td(cell_6, None, clean_val="Test6", style_str=style_6, unit=None)
    ...
    html_0 = extractor._cell_to_html_td(cell_0, None, clean_val="Test0", style_str=style_0, unit=None)
    ...
    html_no_fill = extractor._cell_to_html_td(cell_no_fill, None, clean_val="TestNoFill", style_str=style_no_fill, unit=None)
    ...
    html_no_color = extractor._cell_to_html_td(cell_no_color, None, clean_val="TestNoColor", style_str=style_no_color, unit=None)
