...
def test_cell_to_html_td_styles(tmp_path):
    ...
    html_8 = extractor._cell_to_html_td(cell_8, None, style_8, unit_8)
    ...
    html_6 = extractor._cell_to_html_td(cell_6, None, style_6, unit_6)
    ...
    html_0 = extractor._cell_to_html_td(cell_0, None, style_0, unit_0)
    ...
    html_no_fill = extractor._cell_to_html_td(cell_no_fill, None, style_no_fill, unit_no_fill)
    ...
    html_no_color = extractor._cell_to_html_td(cell_no_color, None, style_no_color, unit_no_color)
