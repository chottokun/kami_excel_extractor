...
def test_cell_to_html_td_styles(tmp_path):
    ...
    html_8 = extractor._cell_to_html_td(cell_8, None, "Test8")
    ...
    html_6 = extractor._cell_to_html_td(cell_6, None, "Test6")
    ...
    html_0 = extractor._cell_to_html_td(cell_0, None, "Test0")
    ...
    html_no_fill = extractor._cell_to_html_td(cell_no_fill, None, "TestNoFill")
    ...
    html_no_color = extractor._cell_to_html_td(cell_no_color, None, "TestNoColor")
