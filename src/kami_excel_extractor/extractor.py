    ...
    def _generate_metadata_and_html(
        ...
        for r_idx, row in enumerate(rows_gen, min_r):
            ...
            for c_idx, (cell, cell_f) in enumerate(zip(row, row_f if row_f else row), min_c):
                ...
                # ⚡ Performance: Use style cache to avoid redundant processing
                style_id = cell.style_id
                if style_id not in self._style_cache:
                ...
                cached_style = self._style_cache[style_id]
                ...
                cell_info = {
                    ...
                    "style": {
                        "borders": cached_style["borders"],
                        "bold": cached_style["bold"],
                    },
                }
                ...
                td_html = self._cell_to_html_td(
                    cell, span, cached_style["style_str"], cached_style["unit"], formula=formula
                )
