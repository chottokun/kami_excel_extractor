...
class MetadataExtractor:
    ...
    def __init__(self, output_dir: Union[str, Path]):
        ...
        self._style_cache: Dict[int, Tuple] = {}
        ...
        for r_idx, row in enumerate(rows_gen, min_r):
            ...
            for c_idx, (cell, cell_f) in enumerate(zip(row, row_f if row_f else row), min_c):
                ...
                if sid is not None and sid in self._style_cache:
                    style_str, borders, unit, bold = self._style_cache[sid]
                else:
                    ...
                    if sid is not None:
                        self._style_cache[sid] = (style_str, borders, unit, bold)
